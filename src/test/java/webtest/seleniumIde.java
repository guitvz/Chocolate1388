...
public class seleniumIde {
    ...
    public void setUp() {
        ...
        driver = new ChromeDriver(options); // instancia o selenium como chromedriver com a configuracao desejada
    ...
    public void login() throws InterruptedException {
        ...
        // carregamento da pagina interna --> demora um pouco
        Thread.sleep(5000); // é um alfinete temporario
        // Este passo não é mais necessário, pois o carrinho ja inicia vazio
