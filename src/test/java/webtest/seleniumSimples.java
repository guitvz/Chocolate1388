...
public class seleniumSimples {
    ...
    public void setUp(){
        ...
        WebDriverManager.chromedriver().setup(); // dowload e instalação do Chrome Driver
        ...
        // Instanciar o Selenium como o drive de um navegador especifico
    ...
    driver.quit(); // destrói o objeto do Selenium Web Driver
    }
