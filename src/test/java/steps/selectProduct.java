...
public class selectProduct {
    ...
    @AfterAll // Executa após todos os blocos de passos --> usar do cumcumber
    ...
    public void i_filled_a_user_and_password(String user, String password) {
        driver.findElement(By.id("user-name")).sendKeys(user); // escreve o conteudo da variavel user
        driver.findElement(By.id("password")).sendKeys(password); // escreve o conteudo da variavel password

        userForCookie = user; // guardar o usuário para apagaro cookie no final
    }
    ...
    public void i_click_in_product(String productId) {
        // Clica no elemento corresponddente ao código do produto informado na feature
    ...
    public void i_verify_the_product_price(String productPrice) {
        // Verefica se o preço do produto corresponde ao informado na feature
    ...
    public void i_click_in_add_to_cart() {
        // Clica no batão de adicionar no carrinho
    ...
    public void i_verify_the_quantity_is(String quantity) {
        // Verifica se a quantidade correspondente a feature
